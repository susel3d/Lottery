...
//        guard let num = Int(pastNumberCandidate), num <= LottoDrawResult.validNumberMaxValue && num > 0 else {
//            pastNumberCandidate = ""
//            return
//        }
...
//                number = Number(value: num, id: number.id)
