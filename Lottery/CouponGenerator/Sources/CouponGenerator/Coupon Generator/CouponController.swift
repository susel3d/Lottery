...
public class CouponController {
    ...
    public init(drawType: DrawType) {
        ...
        commonDataModel = DrawDataModel(drawType: drawType)
    ...
    public func generateCoupons(timeout: TimeInterval,
        ...
        let agesPerPositionModel = AgesPerPositionModel(drawType: drawType)
        ...
        let exclusionModel = ExclusionModel(drawType: drawType)
        exclusionModel.runFor(commonResults: commonResults)

        let bestFriendsModel = BestFriendsModel(drawType: drawType)
